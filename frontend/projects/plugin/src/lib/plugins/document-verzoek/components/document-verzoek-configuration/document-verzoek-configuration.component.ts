...
import {DocumentVerzoekPluginConfig} from '../../models';
  ...
  implements PluginConfigurationComponent, OnInit, OnDestroy
{
  ...
  @Input() prefillConfiguration$: Observable<DocumentVerzoekPluginConfig>;
  @Output() valid: EventEmitter<boolean> = new EventEmitter<boolean>();
  @Output() configuration: EventEmitter<DocumentVerzoekPluginConfig> =
    new EventEmitter<DocumentVerzoekPluginConfig>();

  mappedPrefill$: Observable<DocumentVerzoekPluginConfig>;
  ...
  private readonly formValue$ = new BehaviorSubject<DocumentVerzoekPluginConfig | null>(null);
  ...
  formValueChange(formValue: DocumentVerzoekPluginConfig): void {
  ...
  private handleValid(formValue: DocumentVerzoekPluginConfig): void {
    const valid = !!(
    ...
    this.saveSubscription = this.save$?.subscribe(save => {
      combineLatest([this.formValue$, this.valid$])
        ...
        .subscribe(([formValue, valid]) => {
          const formValueToSave: DocumentVerzoekPluginConfig = {...formValue};
          if (valid) {
